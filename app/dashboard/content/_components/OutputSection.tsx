...
const OutputSection = ({ aiResponse }: { aiResponse: string }) => {
  ...
  return (
    <div spellCheck={false} className='bg-white/40 dark:bg-white/5 dark:shadow-cyan-900 shadow-lg shadow-cyan-100 rounded-lg [&_.toastui-editor-defaultUI]:!bg-inherit [&_.toastui-editor]:!bg-inherit [&_.toastui-editor-main]:!bg-inherit [&_.toastui-editor-ww-container]:!bg-inherit [&_.toastui-editor-toolbar]:!bg-cyan-950 [&_.toastui-editor-contents]:!text-black  '>
